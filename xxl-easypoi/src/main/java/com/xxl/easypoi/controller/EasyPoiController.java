...
import com.xxl.easypoi.common.api.CommonResult;
import com.xxl.easypoi.config.handler.MemberExcelDataHandler;
import com.xxl.easypoi.domain.Member;
import com.xxl.easypoi.domain.Order;
import com.xxl.easypoi.domain.Product;
import com.xxl.easypoi.util.LocalJsonUtil;
...
public class EasyPoiController {
    ...
    @ResponseBody//@RestController是@Controller和@ResponseBody的结合体，两个标注合并起来的作用。
    public String hello() {
