package com.xxl.securitydemo.security.filter;

import com.xxl.securitydemo.security.BadCaptchaAuthenticationException;
import com.xxl.securitydemo.security.EmptyCaptchaAuthenticationException;
...
/**
 * Spring Security 框架默认的 UsernamePasswordAuthenticationFilter 中并没有针对验证码的处理，只有用户名和密码。
 * 因此，我们需要自定义一个包含验证码验证的Filter。
 */
